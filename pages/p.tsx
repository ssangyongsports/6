...
export default function ContactPage() {
  ...
  <h2 className="anchor anchorWithHideOnScrollNavbar_WYt5" id="我們收集的信息">
    我們收集的信息
    <a className="hash-link" href="#我們收集的信息" title="標題的直接連結">
      ​
    </a>
  </h2>
  <p>
  ...
  <h2 className="anchor anchorWithHideOnScrollNavbar_WYt5" id="日誌數據">
    日誌數據
    <a className="hash-link" href="#日誌數據" title="標題的直接連結">
      ​
    </a>
  </h2>
  <p>
    ...
    (IP)
    地址、您的瀏覽器類型和版本、您訪問的頁面、您訪問的時間和日期、在每個頁面上花費的時間、有關您訪問的其他詳細信息以及出現在結合您可能遇到的任何錯誤。
  </p>
  <p>
    請注意，雖然此信息本身可能無法識別個人身份，但有可能將其與其他數據結合以識別個人身份。
  </p>
  <h2 className="anchor anchorWithHideOnScrollNavbar_WYt5" id="個人信息">
    個人信息
    <a className="hash-link" href="#個人信息" title="標題的直接連結">
      ​
    </a>
  </h2>
  ...
  >
    信息的收集和使用
    <a className="hash-link" href="#信息的收集和使用" title="標題的直接連結">
      ​
    </a>
  </h2>
  ...
  >
    您個人信息的安全
    <a className="hash-link" href="#您個人信息的安全" title="標題的直接連結">
      ​
    </a>
  </h2>
  <p>
  ...
  <p>
    雖然我們會盡最大努力保護您提供給我們的個人信息，但我們建議沒有任何一種電子傳輸或存儲方法是
    100%
    安全的，也沒有人能保證絕對的數據安全。對於任何數據洩露，我們將遵守適用於我們的法律。
  </p>
  <p>
  ...
  >
    個人信息的國際傳輸
    <a className="hash-link" href="#個人信息的國際傳輸" title="標題的直接連結">
      ​
    </a>
  </h2>
  <p>
  ...
  <h2 className="anchor anchorWithHideOnScrollNavbar_WYt5" id="cookie-的使用">
    Cookie 的使用
    <a className="hash-link" href="#cookie-的使用" title="標題的直接連結">
      ​
    </a>
  </h2>
  <p>
  ...
  <h2 className="anchor anchorWithHideOnScrollNavbar_WYt5" id="聯繫我們">
    聯繫我們
    <a className="hash-link" href="#聯繫我們" title="標題的直接連結">
      ​
    </a>
  </h2>
  ...
  <p>
    <a
      href="mailto:support@ssangyongsport.eu.org"
      target="_blank"
